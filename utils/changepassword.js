...
const passwordchangeverify = async(UseremailId, OTP) => {
    ...
    var mailOptions = {
        ...
        to: UseremailId,
        subject: 'Reset password on AgroAcers',
        ...
        <div style="margin:50px auto;width:70%;padding:20px 0">
          ...
          <p>Thank you for choosing AgroAcers. Use the following OTP to re-set your password. OTP is valid for 5 minutes</p>
...
module.exports = passwordchangeverify